...
public class RolePermissionController {
	...
	public @ResponseBody RolePermission selectByPrimaryKey(@RequestParam Integer rpId) {
	...
	public @ResponseBody Integer deleteByPrimaryKey(@RequestParam Integer rpId) {
	...
	public @ResponseBody Integer updateByPrimaryKeySelective(@RequestParam RolePermission rolePermission) {
	...
	public @ResponseBody Integer insertSelective(@RequestParam RolePermission rolePermission) {
